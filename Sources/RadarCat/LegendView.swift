...
/// literals a propòsit: és una de les dues úniques excepcions al conveni del
/// projecte de "sense colors literals per a superfícies" (l'altra és el blau
/// de Maps del punt d'ubicació, a `MapOverlays.swift`) perquè aquests són la
/// pròpia llegenda de colors de Meteocat, no un color de superfície de la
/// interfície.
///
