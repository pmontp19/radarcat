...
extension Date {
    /// Cachejat: es llegeix a cada tick d'animació (0.35-0.9s) i a cada
    /// moviment de ratolí durant el scrub del timeline, i recrear un
    /// `DateFormatter` (allocació cara) a cada crida hi era pur malbaratament.
